...
<html>
    <head>
        ...
        <title>Recipe 1-13: Invoking a Function in an Expression</title>
    </head>
    <body>
        ...
        <jsp:useBean id="conditionalBean" scope="page" class="org.jakartaeerecipes.chapter01.recipe01_13.ConditionalClass"/>
